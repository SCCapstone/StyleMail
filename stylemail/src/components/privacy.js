    ...
    render() {
        return (
            <div>
              ...
              <div>
                <h1 className="w3-center">Privacy Policy</h1>
               ...
               <h2 className="w4-center"> Information We Collect </h2>
               ...
               <p> <b>Third Party Platforms.</b> We may collect information when you interact with our advertisements and other content on third-party sites or platforms, such as social networking sites. This may include information such as «Likes», profile information 
                ...
                <h2 className="w4-center">How this Information is Used  </h2>
                ...
                <h2 className="w4-center"> Your Controls and Choices  </h2>
              ...
              <h2 className="w4-center">Your Consent</h2>
