    ...
    return (
        <div>
          <NavBar /> 
            ...
            <div>
                <h1 class="w3-center">FAQ - Frequently Asked Questions</h1>

                <h2 class="w4-center"> What is StyleMail? </h2>
                <p class="w3-center w3-large"> StyleMail is a web app that allows you to pick from and customize stylized HTML and CSS email templates.
                ...
                <h2 class="w4-center"> Why do I need to make an account? </h2>
                <p class="w3-center w3-large"> We understand that you may not want to have to keep track of another username and password. However, even though
                ...
                <p class="w3-center w3-large"> We are very thankful to be able to provide this resource to our customers at no cost. We have a few generous donors 
